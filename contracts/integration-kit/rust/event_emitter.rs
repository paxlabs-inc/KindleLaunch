//! Auto-generated ABI for EventEmitter
//!
//! Usage with alloy:
//!   alloy::sol! { EventEmitter, "event_emitter.json" }
//!
//! Or parse at runtime:
//!   let abi: alloy_json_abi::JsonAbi = serde_json::from_str(EVENT_EMITTER_ABI).unwrap();

/// Raw ABI JSON for EventEmitter
pub const EVENT_EMITTER_ABI: &str = r##"
[
    {
        "inputs": [],
...
mod tests {
    ...
    fn parses_valid_json() {
        let v: serde_json::Value = serde_json::from_str(EVENT_EMITTER_ABI).unwrap();
        assert!(v.is_array());
    }
}
