//! Auto-generated ABI for MetaAGRouter
//!
//! Usage with alloy:
//!   alloy::sol! { MetaAGRouter, "meta_ag_router.json" }
//!
//! Or parse at runtime:
//!   let abi: alloy_json_abi::JsonAbi = serde_json::from_str(META_AG_ROUTER_ABI).unwrap();

/// Raw ABI JSON for MetaAGRouter
pub const META_AG_ROUTER_ABI: &str = r##"
[
    {
        "inputs": [],
...
mod tests {
    ...
    fn parses_valid_json() {
        let v: serde_json::Value = serde_json::from_str(META_AG_ROUTER_ABI).unwrap();
        assert!(v.is_array());
    }
}
