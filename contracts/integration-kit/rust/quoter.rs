//! Auto-generated ABI for Quoter
//!
//! Usage with alloy:
//!   alloy::sol! { Quoter, "quoter.json" }
//!
//! Or parse at runtime:
//!   let abi: alloy_json_abi::JsonAbi = serde_json::from_str(QUOTER_ABI).unwrap();

/// Raw ABI JSON for Quoter
pub const QUOTER_ABI: &str = r##"
[
    {
        "inputs": [],
...
mod tests {
    ...
    fn parses_valid_json() {
        let v: serde_json::Value = serde_json::from_str(QUOTER_ABI).unwrap();
        assert!(v.is_array());
    }
}
